...
router.post('/create', auth, (req, res, next) => {
  if (req.user && req.user._id) {
    if (
      ...
      res.send('You have the create capability and can create content');
      return;
    }
  }
...
router.delete('/delete', auth, (req, res, next) => {
  if (req.user && req.user._id) {
    if (
      ...
      res.send('You have the delete capability and can delete content');
      return;
    }
  }
